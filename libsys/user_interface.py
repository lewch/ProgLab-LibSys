...
class UserInterface:
    """
    A class draws user interfaces and provide them to users to interact with the system.
    """
    ...
    def __init__(self, title_manager, student_manager):
        ...
        """
        # The instance of user interaction controls the interactions with users
    ...
    def screen(header, options):
        ...
        chosen for interactions. Please note that the last option is
    ...
    def main_screen(self):
        ...
        options = [Option(description="Admin Login",
                   ...
                   Option(description="Exit", func=exit)]
